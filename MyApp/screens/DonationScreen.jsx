...
export default function DonationScreen({ navigation }) {
  ...
  const buildPayload = () => {
    ...
    const gcashReferenceNumber = sanitizeNumericReference(
...
function MonetaryFields({
  ...
  return (
    <>
      ...
      <Field label="Amount" styles={styles} fieldRef={registerField("amount")}>
        <TextInput
          style={styles.input}
      ...
      <Field
        ...
        styles={styles}
        fieldRef={registerField("gcashReferenceNumber")}
      >
        <TextInput
          style={styles.input}
          ...
          onChangeText={(value) =>
            updateField("gcashReferenceNumber", sanitizeNumericReference(value))
          }
      ...
      <Field
        ...
        styles={styles}
        fieldRef={registerField("description")}
      >
        <TextInput
...
function Field({ label, children, styles, fieldRef }) {
  return (
