...
export default function RegisterFlow() {
  ...
  const [smsCooldown, setSmsCooldown] = useDeadlineCountdown(0);
  const [emailCooldown, setEmailCooldown] = useDeadlineCountdown(0);
  const [resendLockout, setResendLockout] = useDeadlineCountdown(0);
  ...
  useEffect(() => {
    if (resendLockout === 0) setResendAttempts(0);
  }, [resendLockout]);
